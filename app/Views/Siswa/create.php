...
<div class="col-md-6">
    <?= form_open_multipart('/siswa'); ?>
    <h6 class="lead mb-3">Silahkan lengkapi form berikut ini :</h6>
    <?= csrf_field(); ?>
    <div class="form-floating mb-3">
        <input type="number" class="form-control <?= ($validation->getError('nis')) ? 'is-invalid' : ''; ?>" name="nis" id="nis" placeholder="Nomor Induk Siswa">
        <label for="nis">Nomor Induk Siswa</label>
        <small class="invalid-feedback"><?= $validation->getError('nis'); ?></small>
    </div>
    <div class="form-floating mb-3">
        <input type="text" class="form-control <?= ($validation->getError('nama')) ? 'is-invalid' : ''; ?>" name="nama" id="nama" placeholder="Nama Lengkap" required>
    ...
    <div class="form-floating mb-3">
        <input type="email" class="form-control <?= ($validation->getError('email')) ? 'is-invalid' : ''; ?>" name="email" id="email" placeholder="Alamat Email">
    ...
    <div class="form-floating mb-4">
        <input type="number" class="form-control" name="no_hp" id="no_hp" placeholder="Nomor Handphone/WA" required>
...
<div class="col-md-6">
    ...
    <img src="/uploads/default.png" alt="" class="img-preview mb-4" width="200">
    <div>
