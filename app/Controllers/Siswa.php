...
class Siswa extends BaseController
{
    ...
    public function delete()
    {
        ...
        if ($row > 0) {
            session()->setFlashdata('siswa', '<div class="alert alert-info alert-dismissible fade show" role="alert">
            <strong>Success!</strong> Data siswa berhasil dihapus dari database.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>');
            return redirect()->to('/siswa');
        } else {
            session()->setFlashdata('siswa', '<div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Failed!</strong> Data siswa gagal dihapus dari database.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>');
            return redirect()->to('/siswa');
        }
    ...
    public function update()
    {
        ...
        $data = $this->request->getPost();
        $photoLama = $this->request->getPost('photo_lama');
        ...
        if ($row > 0) {
            session()->setFlashdata('siswa', '<div class="alert alert-info alert-dismissible fade show" role="alert">
            <strong>Success!</strong> Data siswa berhasil diupdate di dalam database.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>');
            return redirect()->to('/siswa');
        } else {
            session()->setFlashdata('siswa', '<div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Failed!</strong> Data siswa gagal diupdate di dalam database.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>');
            return redirect()->to('/siswa');
        }
